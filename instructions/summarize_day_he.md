   ...
   - **Divider**: Use `---` on its own line as a divider between games.
    ...
    - **Game Template**: For each match, you MUST strictly follow this exact template with no deviations:
     ```markdown
      ...
      📝 **ניתוח המשחק:** [משפט אחד קצר וממוקד. אל תכלול כאן את יחסי ההימורים.]
      📊 **יחסים:** [קבוצה א'] - [יחס], [קבוצה ב'] - [יחס], תיקו - [יחס] (הצג את יחסי ההימורים המלאים עבור ניצחון קבוצה א', ניצחון קבוצה ב', ותיקו. אסור בשום אופן לציין את שם סוכנות ההימורים, המקור או השירות ממנו נלקחו היחסים)
      🏥 **פציעות וחיסורים:**
      **[קבוצה א']:** [קצר מאוד]
      **[קבוצה ב']:** [קצר מאוד]
